                ...
                return (
                  <tbody>
                    <tr>
                      ...
                      <td className={styles.tDataImage}><img className="w-25" src={item?.productImage} alt="image" /> {item.productName}</td>
                      <td className={styles.tData}>{item.unitPrice}</td>
                      <td className={styles.tData}>{item.qty}</td>
                      <td className={styles.tData}>{item.subTotal}</td>
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className={`${styles.inputGrop} input-group mb-3`}>
                    <input type="text" className={` ${styles.inputField} form-control`} placeholder="Enter Promo Code" aria-label="Recipient's username" aria-describedby="basic-addon2" />
                    <span className={`${styles.applyBtn}`} id="basic-addon2">Apply</span>
                  </div>

                </div>
                <div className="col-lg-6">
                  <div className="row">
                    <div className="col-lg-8">   <span className={styles.subTotal}>Sub Total</span></div>
                    <div className="col-lg-4">  <span className={styles.subPrice}>$ 700.15</span></div>
                  </div>
