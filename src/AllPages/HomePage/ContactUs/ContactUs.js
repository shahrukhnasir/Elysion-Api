						...
						<div className="col-lg-6" data-aos="fade-down"
							...
							<div className="mb-2">
								<div className={styles.loc_sec}>
									...
									<div>
										<span className={styles.points} data-aos="fade-up"
											data-aos-duration="2000">
											Kindly utilize the provided address to send correspondence to the provider or practice of Elysion Health & Wellness:
							...
							<div className={styles.loc_sec}>
								...
								<span className={styles.points} data-aos="fade-up"
									data-aos-duration="2000">Please call us at the following number: <a href="tel:4703002259">4703002259</a></span>
							</div>
						</div>

						<div className="col-lg-6 p-5" id={styles.form} data-aos="fade-right"
							data-aos-offset="300"
