      ...
      <div className="container-fluid p-0">
          ...
          <div className="row">
            ...
            <div className="col-lg-6 py-5">
              <p className={styles.Desc}>
                If you have any inquiries unrelated to health matters, please reach out to Elysion using the form provided below. Please note that this communication method should not be used for urgent or confidential medical concerns. For inquiries regarding your healthcare or to request your medical records <Link href="">click here</Link>, we recommend visiting the patient portal or contacting your physician's office </p>



              <div className="row">
                <div className="col-lg-6">
                  <span> <img src="./images/locationIcon.png" className={styles.soclIcon} alt="img" /></span>
                  <span className={styles.textBlue}> Kindly utilize the provided address to send correspondence to the provider or practice of Elysion Health & Wellness:
                  Location 3698 Largent Way, Suite 102, Marietta GA 30064.</span>

                </div>

                <div className="col-lg-6">
                  <span>  <IoMdCall className={styles.soclIcon} />
                  </span>
                  <span className={styles.textBlue}>Please call us at the following number
        ...
        <div className={`${styles.mapContainer} container`}>
          ...
          <div className={styles.google_map}>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3309.4669184428494!2d-84.65869113501329!3d33.954836506933404!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88f53e9b41e195d5%3A0xa21a8327a8fb27d8!2s3698%20Largent%20Way%2C%20Marietta%2C%20GA%2030064%2C%20USA!5e0!3m2!1sen!2s!4v1696409396862!5m2!1sen!2s" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
