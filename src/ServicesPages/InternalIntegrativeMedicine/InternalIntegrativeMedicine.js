            ...
            <div className="row">
              <div className="col-lg-6 py-3">
                <p className={styles.paragraph}>
                  combines conventional medical practices with complementary and
                  lternative therapies to provide wholistic, patient-centered
                  care. It focuses on treating the whole person and addressing
                  the root causes of illness. This approach integrates the
                  expertise of internal medicine physicians with evidence-based
                  complementary therapies such as lifestyle management
                  acupuncture, herbal medicine, and mindfulness-based stress
                  reduction. The goal is to optimize health outcomes by
                  considering physical, emotional, social, and environmental
                  factors, and developing personalized treatment plans
                </p>
